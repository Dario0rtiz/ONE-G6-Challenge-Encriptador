...
function actualizarPantalla(){
    ...
    '<textarea maxlength="5000" cols="50" rows="15" id="resultado" class="texto"></textarea>' + 
...
function encriptaMensaje(){
    ...
    else alert("Por favor, ingrese un mensaje en minúsculas y sin tildes");
}
...
copiar.onclick = copiarTexto;
encriptar.onclick = encriptaMensaje;
desencriptar.onclick = desencriptaMensaje;
